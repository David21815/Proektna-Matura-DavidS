            ...
            <div className="md:flex w-full">
              ...
              <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {/* Submit button */}
                  <div className="flex -mx-3">
                  <div className="flex flex-col w-full px-3 mb-5 items-center">
                      <button
                        type="submit"
                      ...
                      <button
                        className="mt-4 px-4 py-2 w-[150px] bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none"
